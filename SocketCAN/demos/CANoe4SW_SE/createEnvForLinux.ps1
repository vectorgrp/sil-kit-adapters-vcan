...
if ($remote) 
{
	...
	$remote_SKA_base_path="/home/$remote_username/SilKit/sil-kit-adapters-vcan"
	...
	scp -r $PSScriptRoot/Default.venvironment $PSScriptRoot/test_CAN_EchoDevice.vtestunit "${remote_username}@${remote_ip}:${remote_full_path}"
	Write-Host "Done."
}
